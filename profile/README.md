...
Here we collect, share and archive our code.
...
Suggested structure for our repositories:
`<category>-<topic>-<year>`
...
- `modelling-miecode-2025`
- `experiment-SEMS-calibration-2025`
- `infrastructure-read-CVI`
...
2. Now click on Owner and choose 'SU-air', then rename the repo according to our naming conventions (see above) and click 'Create fork'. 
<img width="516" height="356" alt="image" src="https://github.com/user-attachments/assets/31a2b203-3c64-40d0-ac78-e5edac8384d9" />
